    ...
    public String resetPass(String username,String password){
        ...
        try{
                    ...
                    if(rs==null)
                        ...
                        while(rs.next()){
                            if(password.equals(rs.getString(5))&&username.equals(rs.getString(4))){
            ...
            if(new String(p1.getPassword()).equals(new String(p2.getPassword()))){
                try{
                    ...
                    if(rs==null)
                        ...
                        while(rs.next()){
                            if(this.username.equals(rs.getString(4))){
                                st=con.createStatement();
                                query="update student_login set password=\'"+(new String(p1.getPassword()))+"\' where login=\'"+this.username+"\'";
                                System.out.println(query);
